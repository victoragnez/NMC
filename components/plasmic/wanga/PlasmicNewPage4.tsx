...
import * as sty from "./PlasmicNewPage4.module.css"; // plasmic-import: Qlzg8LOrY1/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"497936"}</title>
        <meta key="og:title" property="og:title" content={"497936"} />
      </Head>
      ...
      <div className={defaultcss.plasmic_page_wrapper}>
        ...
        >
          <img
            ...
            src={"/plasmic/wanga/images/_497936Page0011Jpg.jpeg"}
          />
        </div>
      </div>
    </React.Fragment>
